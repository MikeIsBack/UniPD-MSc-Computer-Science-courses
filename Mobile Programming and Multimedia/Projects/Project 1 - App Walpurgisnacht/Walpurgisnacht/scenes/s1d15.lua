...
local function gotoNextDream()
  ...
  settings.currentDream = 16
  gotoDreaming()
end

local function gotoSameDream()
  audio.play( t_audio.confirm )
  settings.currentDream = 15
  gotoDreaming()
end
...
local t_cbtplayer = {
  ...
  orange_count, red_count, white_count,
...
function scene:create( event )
  ...
  t_tutorial.playerTutorial = {
    "La strega che era in questo livello è momentaneamente assente", --1
    "Grazie per aver giocato a questa versione di Walpurgisnacht",
    "Alla prossima!" --3
  }
